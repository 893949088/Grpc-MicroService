...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public class UnitOfWork<TContext> : IDbRepositoryFactory, IUnitOfWork<TContext>, IUnitOfWork where TContext : DbContext
    {
        ...
        public IDbRepository<TEntity> GetRepository<TEntity>() where TEntity : BaseEntity
        {
            ...
            {
                repositories[type] = new DbRepository<TEntity>(_context);
            }

            return (IDbRepository<TEntity>)repositories[type];
        }
